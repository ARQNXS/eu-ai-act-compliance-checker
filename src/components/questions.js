const questions = [
  {
    text: 'Does your AI system prohibits the use of techniques that could exploit human vulnerabilities, manipulate behavior, or cause physical or psychological harm, such as an AI-powered social media platform that encourages addictive behaviors or an AI system that influences voting decisions?',
  ...
  {
    text: 'Does your AI system prohibits the use of performing remote biometric identification of individuals in real-time and in publicly accessible spaces, such as live facial recognition systems in public transport or shopping malls?',
  ...
  {
    text: 'Is your AI system not designed to interact with or make decisions that significantly affect individuals, such as profiling, facial recognition, or determining access to essential services like healthcare, education, or employment?',
  ...
  {
    text: 'Is your AI system not designed to be used by law enforcement, immigration authorities, or the judiciary for tasks such as predicting the occurrence or reoccurrence of crimes, profiling individuals, or assessing the risk posed by individuals or groups?',
  ...
  {
    text: 'Does your AI system prohibits the use of biometric data, such as fingerprints, facial images, or voice recordings, to identify or categorize individuals?',
  ...
  {
    text: 'Is your AI system not designed to interact with children or make decisions that may affect their rights, such as in the context of education, childcare, or online services specifically targeted at children?',
  ...
  {
    text: 'Does your AI system prohibits the use of techniques that could lead to discrimination against individuals or groups based on protected characteristics, such as race, gender, age, or disability?',
  ...
  {
    text: 'Does your AI system prohibits the use of techniques that could infringe on individuals\' privacy rights, such as processing personal data without appropriate legal basis or safeguards?',
  ...
  {
    text: 'Is your AI system not designed to be used in the context of employment, such as for hiring, performance evaluation, promotion, or termination decisions?',
  ...
  {
    text: 'Does your AI system prohibits the use of techniques that could influence individuals\' behavior or choices in a way that may be detrimental to their well-being or autonomy, such as through personalized advertising or content recommendations?',
  ...
  {
    text: 'Is your AI system not designed to generate or manipulate audio, video, or images that could be used to deceive individuals or spread disinformation, such as deepfakes or synthetic media?',
  ...
  {
    text: 'Does your AI system prohibits the use of techniques that could have a significant environmental impact, such as through high energy consumption or the use of rare or hazardous materials?',
  ...
  {
    text: 'Is your AI system not intended to be used in a sector or domain where the EU has established specific regulations or standards, such as healthcare, finance, or transportation?',
  ...
  {
    text: 'Does your AI system not use techniques that could perpetuate or amplify existing societal biases or stereotypes, such as in the context of content moderation, targeted advertising, or search results ranking?',
    ...
    {
    text: 'Is your AI system not designed to interact with or assist individuals with disabilities or other vulnerable groups, such as the elderly or those with limited digital literacy?',
    ...
    {
    text: 'Does your AI system prohibits the use of techniques that could have a significant impact on cultural diversity or the preservation of cultural heritage, such as in the context of language translation, content recommendation, or cultural analytics?',
    ...
    {
    text: 'Is your AI system not designed to be used in the context of scientific research or innovation, such as for data analysis, hypothesis generation, or experimental design?',
    ...
    {
    text: 'Does your AI system prohibits the use of techniques that could have a significant impact on the environment or wildlife, such as in the context of environmental monitoring, wildlife conservation, or natural resource management?',
    ...
    {
    text: 'Is your AI system not designed to be used in the context of national security, defense, or intelligence, such as for surveillance, threat detection, or predictive analysis?',
    ...
    {
    text: 'Does your AI system prohibits the use of techniques that could have a significant impact on freedom of expression or access to information, such as in the context of content moderation, news aggregation, or information filtering?',
    ...
    {
    text: 'Is your AI system not designed to be used in the context of public administration or e-government services, such as for automated decision-making, resource allocation, or citizen engagement?',
    ...
    {
    text: 'Does your AI system prohibits the use of techniques that could have a significant impact on consumer rights or protection, such as in the context of personalized pricing, automated customer service, or product recommendations?',
    ...
    {
    text: 'Is your AI system not designed to be used in the context of urban planning, smart cities, or transportation management, such as for traffic optimization, resource allocation, or infrastructure monitoring?',
    ...
    {
    text: 'Does your AI system prohibits the use of techniques that could have a significant impact on democratic processes or institutions, such as in the context of voter profiling, political advertising, or opinion polling?',
    ...
    {
    text: 'Is your AI system not designed to be used in the context of energy management or sustainability, such as for smart grid optimization, renewable energy forecasting, or energy efficiency monitoring?',
    ...
    {
    text: 'Does your AI system prohibits the use of techniques that could have a significant impact on public health or safety, such as in the context of disease surveillance, drug development, or food safety monitoring?',
    ...
    {
    text: 'Is your AI system not designed to be used in the context of creative industries, such as for content creation, style transfer, or personalized recommendations in areas like music, art, or fashion?',
    ...
    {
    text: 'Does your AI system prohibits the use of techniques that could have a significant impact on media pluralism or the diversity of news and information sources, such as in the context of content curation, news aggregation, or media monitoring?',
    ...
    {
    text: 'Is your AI system not designed to be used in the context of international development or humanitarian aid, such as for poverty alleviation, disaster response, or refugee assistance?',
